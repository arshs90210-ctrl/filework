...
function applyMassRoute() {
    ...
    const raw = document.getElementById('massRouteString').value;
    ...
    alert(`Updated routes for ${count} Felt Codes.`);
    document.getElementById('massRouteModal').style.display='none';
    renderSequencingTable();
    saveLocalState();
    runEngine();
}
